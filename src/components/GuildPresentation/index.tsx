  ...
  return (
    <S.Container>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            de s'installer sur le serveur Trixion. Nous recherchons des joueurs
            qui souhaitent se joindre à nous et reprendre l'aventure. Nous
            sommes une guilde conviviale et accueillante, et nous aimons
            partager et échanger avec les autres joueurs. Nous encourageons
            également la présence vocale pour favoriser la communication et la
            coordination.
          </p>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <p>
            Si vous souhaitez obtenir plus d'informations sur la guilde Steins
            Gate, n'hésitez pas à contacter @Swiichy ou @Shu. Vous pouvez
            également nous rejoindre sur notre serveur Discord : [lien vers le
            serveur Discord]
